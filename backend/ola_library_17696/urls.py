"""ola_library_17696 URL Configuration
...
admin.site.site_header = "Ola library"
admin.site.site_title = "Ola library Admin Portal"
admin.site.index_title = "Ola library Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Ola library API",
        default_version="v1",
        description="API documentation for Ola library App",
    ),
    public=True,
